                        ...
                        <div class="panel-body">
                             ...
                             <form action="processInsert.php" method="post" enctype="multipart/form-data">
                                        <table cellpadding="50" >
                                            <tr>
                                           		<td width="51">Name</td>
                                              		<td width="1"> : </td>
                                       		 	 <td width="657">&nbsp; &nbsp;<span id="sprytextfield1">
      							<input type="text" name="product_name" id="name" placeholder="CAPITAL LETTER"/>
    							<span class="textfieldRequiredMsg">A value is required and capital letter.</span></span>				
							</td>
                                            </tr>
                                            <tr>                                          
                                                 <td colspan="3"></br> </td>
							...
							<font color="#0099FF"> optional </font></td>
                                            ...
                                            <tr>
                                                 ...
                                                 <input type="text" name="price" id="price" placeholder="30.00 / 3.50"/>
                                            ...
                                            <tr>
                                                 ...
                                                 <td>&nbsp; &nbsp;  &nbsp;<span id="sprytextfield3">
                                                   <input type="text" name="barcode" id="barcode" placeholder="0123456789"/>
                                             ...
                                             <tr>
                                                      ...
                                                      <td> : </td>
                                                      <td>&nbsp; &nbsp; &nbsp; 
                                                        <input type="text" name="weight" id="weight" placeholder="1/2KG , 2KG, 1.4KG or 8 Inch"/>
							<font color="#0099FF"> optional </font>
                                                        </td>
                                          </tr>
                                             <tr>                                          
                                                 <td colspan="3"></br> </td>
                                            ...
                                            <tr>     
                                             ...
                                             <tr>
                                           		 <td>Stock</td>
                                                 <td> : </td>
                                            	 <td>&nbsp; &nbsp;<input type="radio" name="stock" value="Yes">Stock Available
                                                     <br/>
                                                     &nbsp; &nbsp;<input type="radio" name="stock" value="No">Stock Not Available
