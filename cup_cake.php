      ...
      <div class="row">
        ...
        <div class="col-sm-9 padding-right">
          <div class="features_items"><!--features_items-->
            <h2 class="title text-center"> Cup Cake</h2>
            <?php
...
<ul class="pagination">
  <li><?php echo "<a href='cup_cake.php?page=1'>".'|<'."</a> "; // Goto 1st page    ?></li>
    ...
    { 
      ...
      <li class="active"> <?php echo "<a href='cup_cake.php?page=".$i."'>".$i."</a> "; ?> </li>
      
      <?php
      } 
      if($page != $i) 
      { ?>
      <li> <?php  echo "<a href='cup_cake.php?page=".$i."'>".$i."</a> "; ?> </li>
...
<li> <?php echo "<a href='cup_cake.php?page=$total_pages'>".'>|'."</a> "; // Goto last page  ?>  </li>
