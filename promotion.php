      ...
      <div class="row">
        ...
        <div class="col-sm-9 padding-right">
          <div class="features_items"><!--features_items-->
            <h2 class="title text-center">Promotion</h2>
            <?php
...
$query1= "SELECT * FROM product p JOIN product_price USING (product_id) WHERE product_category = '1' AND product_status='8' LIMIT $start_from , $num_rec_per_page";
            ...
            <div class="col-sm-4">
              <div class="product-image-wrapper">
                  ...
                  <div class="productinfo text-center">
                    ...
                    <input type="hidden" name="location" value="promotion.php">
...
$query2= "SELECT * FROM product WHERE product_category = 'Promotion' ";
...
<ul class="pagination">
  <li><?php echo "<a href='promotion.php?page=1'>".'|<'."</a> "; // Goto 1st page    ?></li>
    ...
    { 
      ...
      <li class="active"> <?php echo "<a href='promotion.php?page=".$i."'>".$i."</a> "; ?> </li>
      
      <?php
      } 
      if($page != $i) 
      { ?>
      <li> <?php  echo "<a href='promotion.php?page=".$i."'>".$i."</a> "; ?> </li>
...
<li> <?php echo "<a href='promotion.php?page=$total_pages'>".'>|'."</a> "; // Goto last page  ?>   </li>
