			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Cookies</h2>
						<?php
...
$query1= "SELECT * FROM product p JOIN product_price USING (product_id) WHERE product_category = '4' AND product_status='8' LIMIT $start_from , $num_rec_per_page";
							...
							<div class="product-image-wrapper">
                            	<div class="single-products">
									<div class="productinfo text-center">
					                    ...
					                    <input type="hidden" name="location" value="cookies.php">
...
$query2= "SELECT * FROM product WHERE product_category = '4' ";
...
<ul class="pagination">
	<li><?php echo "<a href='cookies.php?page=1'>".'|<'."</a> "; // Goto 1st page    ?></li>
		...
		{ 
			...
			<li class="active"> <?php echo "<a href='cookies.php?page=".$i."'>".$i."</a> "; ?> </li>
			
			<?php
			} 
			if($page != $i) 
			{ ?>
			<li> <?php  echo "<a href='cookies.php?page=".$i."'>".$i."</a> "; ?> </li>
...
<li> <?php echo "<a href='cookies.php?page=$total_pages'>".'>|'."</a> "; // Goto last page  ?>	 </li>
